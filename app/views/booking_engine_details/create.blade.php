...
@section('main')
            <div class="page-title">
              <div class="title_left">
                <h3>Create Booking_engine_detail <small></small></h3>
              </div>
            </div>
        ...
        @endif
            <div class="row">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Create Booking_engine_detail <small></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />

                    {{ Form::open(array('id' => 'demo-form2','route' => 'booking_engine_details.store','data-parsley-validate', 'class' => 'form-horizontal form-label-left')) }}
