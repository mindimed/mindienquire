...
@section('main')
            <div class="page-title">
              <div class="title_left">
                <h3>Edit Email_setting <small></small></h3>
              </div>
            </div>
        ...
        @endif
            <div class="row">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit Email_setting <small></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    {{ Form::model($email_setting, array('class' => 'form-horizontal form-label-left', 'method' => 'PATCH','data-parsley-validate', 'route' => array('email_settings.update', $email_setting->id))) }}
              ...
              {{ Form::text('status', Input::old('status'), array('class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Status')) }}
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          {{ link_to_route('email_settings.show', 'Cancel', $email_setting->id, array('class' => 'btn btn-lg btn-default')) }}
