...
@section('main')
        ...
        @endif
            <div class="row">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit Outbox <small></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    {{ Form::model($outbox, array('class' => 'form-horizontal form-label-left', 'method' => 'PATCH','data-parsley-validate', 'route' => array('outboxes.update', $outbox->id))) }}
              ...
              {{ Form::text('title', Input::old('title'), array('class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Title')) }}
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          {{ link_to_route('outboxes.show', 'Cancel', $outbox->id, array('class' => 'btn btn-lg btn-default')) }}
