...
@section('main')
            <div class="page-title">
              <div class="title_left">
                <h3>Create Email_template <small></small></h3>
              </div>
            </div>
        ...
        @endif
            <div class="row">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Create Email_template <small></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />

                    {{ Form::open(array('id' => 'demo-form2','route' => 'email_templates.store','data-parsley-validate', 'class' => 'form-horizontal form-label-left')) }}
