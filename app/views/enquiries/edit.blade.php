        ...
        @endif
            <div class="row">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    {{ Form::model($enquire, array('class' => 'form-horizontal form-label-left', 'method' => 'PATCH','data-parsley-validate', 'route' => array('enquiries.update', $enquire->id))) }}
              ...
              {{ Form::text('currency', Input::old('currency'), array('class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Currency')) }}
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          {{ link_to_route('enquiries.show', 'Cancel', $enquire->id, array('class' => 'btn btn-lg btn-default')) }}
