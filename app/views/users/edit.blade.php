        ...
        @endif
            <div class="row">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    {{ Form::model($user, array('class' => 'form-horizontal form-label-left', 'method' => 'PATCH','data-parsley-validate', 'route' => array('users.update', $user->id))) }}
