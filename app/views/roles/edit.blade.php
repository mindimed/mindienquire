        ...
        @endif
            <div class="row">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    {{ Form::model($role, array('class' => 'form-horizontal form-label-left', 'method' => 'PATCH','data-parsley-validate', 'route' => array('roles.update', $role->id))) }}
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          {{ link_to_route('roles.show', 'Cancel', $role->id, array('class' => 'btn btn-lg btn-default')) }}
