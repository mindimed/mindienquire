...
@section('main')
            <div class="page-title">
              <div class="title_left">
                <h3>Edit Booking_engine <small></small></h3>
              </div>
            </div>
        ...
        @endif
            <div class="row">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit Booking_engine <small></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    {{ Form::model($booking_engine, array('class' => 'form-horizontal form-label-left', 'method' => 'PATCH','data-parsley-validate', 'route' => array('booking_engines.update', $booking_engine->id))) }}
              ...
              {{ Form::text('method', Input::old('method'), array('class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Method')) }}
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          {{ link_to_route('booking_engines.show', 'Cancel', $booking_engine->id, array('class' => 'btn btn-lg btn-default')) }}
