...
@section('main')
              ...
              <div class="title_left">
                <h3>All Booking_engines <small></small></h3>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>{{ link_to_route('booking_engines.create', 'Add New Booking_engines', null, array('class' => 'btn btn-lg btn-success')) }}</h2>
				...
				<th>Method</th>
                      ...
                      <tbody>
                        @foreach ($booking_engines as $booking_engine)
          							<tr>
